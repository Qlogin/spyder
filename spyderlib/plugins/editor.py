...
class EditorConfigPage(PluginConfigPage):
    ...
    def setup_page(self):
        ...
        fpsorting_combo = self.create_combobox(_('File tabs sorting'),
                                               ((_('None'), None),
                                                (_('By name'), False),
                                                (_('By full path'), True)),
                                               'fullpath_sorting')
        ...
        interface_layout.addWidget(fpsorting_combo)
...
class Editor(SpyderPluginWidget):
    ...
    def create_new_window(self):
        ...
        fullpath_sorting=self.get_option('fullpath_sorting', None),
    ...
    def run_winpdb(self):
        ...
        if self.save():
            ...
            programs.run_program(WINPDB_PATH, [fname] + args, cwd=wdir or None, env=env)
